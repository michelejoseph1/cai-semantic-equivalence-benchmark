...
def judge_strain_v2(answer_a: str, answer_b: str) -> float:
    ...
    system_prompt = (
        ...
        "0.25 = Same main claim and qualifiers, with only minor differences in phrasing or detail.\n"
        "0.50 = Noticeable differences in content, emphasis, or implied claims, "
        "but not clearly contradictory.\n"
        "0.75 = Strong tension or opposing implications; they seem to pull in different directions.\n"
        "1.0  = Direct contradiction or mutually exclusive claims.\n\n"
        "Important:\n"
        "- Focus on meaning, not wording.\n"
        "- Ignore harmless extra elaboration or examples if the core claim matches.\n"
        "- Always return a JSON object with a single field: score.\n"
        '  For example: {\"score\": 0.75}\n"
    )
